...
<body>
                        ...
                        <div class="row">
                            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                                <div class="animated bounceInDown slider-captions">
                                    <h2 class="slider-title">V United Care for Kids (VUCFK) has been established in
                                        Canada </h2>
                    ...
                    <div class="row">
                        <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-12 col-xs-12">
                            <div class="slider-captions ">
                                <h2 class="slider-title">V United Care for Kids (VUCFK) has been established in Canada
                                </h2>
                                <p class="slider-text hidden-xs"></p>
                            </div>
                        </div>
            ...
            <div class="row natur-row no-margin w-100">
                <div class="text-part col-md-12">
                    ...
                    <p style="font-size:18px;">
                        ...
                        Welcome to V United Care for Kids (VUCFK), a passionate and visionary organization dedicated to
                        building a
                        socially and economically strong society through education. Established in Canada for charitable
                        purposes and
    ...
    <!-- ################# Events Start Here#######################--->
    <section class="events" style="background-color:#A2A09F; color:black;">
        <div class="container">

            <div class="event-ro row">
                <div class="col-md-6 col-sm-12">
                    <div class="event-box">
                        <img src="public/assets/images/events/child.jpg" alt="">
                        <h3>Child Education</h3>


                        <p style="text-align:justify;">Child Education charities focus on providing resources, support,
