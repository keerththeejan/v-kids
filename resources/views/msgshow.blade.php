                    ...
                    <form action="updatemsg" method="POST">
                        ...
                        ?>
                            <div class="form-group">
                                ...
                                <input type="text" id="sname" name="sid" class="form-control" value="{{ $student->student_id }}" required>
                            </div>
                        <?php
                        } ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="yname" name="yname" class="form-control" value="{{ $student->name }}" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="message" name="message" class="form-control" rows="4" required>{{ $student->message }}</textarea>
                        </div>

                        <button type="submit" class="btn btn-dark">Update Message</button>
                    </form>
                </div>
            </div>
        </section>
