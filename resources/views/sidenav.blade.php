<div class="main-sidebar sidebar-style-2">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand">
            <a href="index.html"> <img alt="image" src="public/adminpanel/img/logo.jpg" class="header-logo" /> <span
                    class="logo-name">VanniChankam</span>
            </a>
        </div>
        <ul class="sidebar-menu">
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                        data-feather="users"></i><span>Donars</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="#" class="menu-toggle nav-link has-dropdown"><i
                        data-feather="file-text"></i><span>News</span></a>
                <ul class="dropdown-menu">
            ...
            <li class="dropdown">
                <a href="package" class="nav-link"><span><i class="fas fa-file-alt"></i>Packages</span></a>
            </li>
