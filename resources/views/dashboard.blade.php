                                            ...
                                            <div class="row ">
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pl-0">
                                                    <div class="banner-img">
                                                        <img src="public/adminpanel/img/banner/1.png" alt="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="public/adminpanel/img/users/user-1.png" class="user-img mr-2"
                                                alt="">
                                            <div class="media-body ml-3">
                                                ...
                                                <p class="my-1">Hi, can you please add new table for advan...
                                                </p>
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="public/adminpanel/img/users/user-2.png" class="user-img mr-2"
                                                alt="">
                                            <div class="media-body ml-3">
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="public/adminpanel/img/users/user-3.png" class="user-img mr-2"
                                                alt="">
                                            <div class="media-body ml-3">
                                                ...
                                                <a href="javascript:void(0)">Are you provide template in
                                                    Angular?</a>
                                                <p class="my-1">can you provide template in latest angular 8.
                                                </p>
                                                <small class="text-muted">Created by <span
                                        ...
                                        <div class="support-ticket media pb-1 mb-3">
                                            <img src="public/adminpanel/img/users/user-6.png" class="user-img mr-2"
                                                alt="">
                                            <div class="media-body ml-3">
                                                ...
                                                <p class="my-1">Hi, John, can you work on increase page speed
                                                    of template...</p>
                                                <small class="text-muted">Created by <span
